...
class HeroSlideResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'ภาพสไลด์หน้าแรก';
    protected static ?string $modelLabel = 'ภาพสไลด์';
    protected static ?string $pluralModelLabel = 'ภาพสไลด์หน้าแรก';
